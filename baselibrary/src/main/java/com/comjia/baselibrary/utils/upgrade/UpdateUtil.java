...
public class UpdateUtil {
    ...
    private static final String TAG = "comjia.update";
    private static final String PREFS = "comjia.update.prefs";
    private static final String KEY_IGNORE = "comjia.update.prefs.ignore";
    private static final String KEY_UPDATE = "comjia.update.prefs.update";
